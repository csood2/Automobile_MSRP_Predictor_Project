...
**Using the log transformation, we have satisfied the assumption of normality of errors.**
...
**Additionally, the histogram of the residuals and the Q-Q Plot are much better than before, both indicating that we have moved towards meeting the normality assumption.**
...
**As we saw from the VIF results, there are a few predictors which show sighns of multicollinearity. We can start by removing the predictor Engine.Cylinders, since all the dummy variables associated to it have high VIFs and their p-values are also high from the summary.**
